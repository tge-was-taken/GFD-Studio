...
namespace GFDLibrary.IO.Resource
{
    internal class ResourceWriter : IDisposable
    {
        ...
        public static void WriteToStream( GFDLibrary.Resource resource, Stream stream, Endianness endianness )
        {
        ...
        private void WriteResourceFile( GFDLibrary.Resource resource )
        {
        ...
        private void WriteResource( GFDLibrary.Resource resource )
        {
