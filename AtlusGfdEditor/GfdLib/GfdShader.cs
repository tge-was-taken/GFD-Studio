...
namespace AtlusGfdEditor.GfdLib
{
    public sealed class GfdShader
    {
        ...
        internal GfdShader(ushort type, ushort field06, uint field08, uint field0C, uint field10, float field14, float field18, byte[] data)
        {
            Type = type;
            Field06 = field06;
            Field08 = field08;
